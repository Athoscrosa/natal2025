...
class Connection
{
    ...
    public static function connection(): PDO
    {
        ...
        try {
            ...
            static::$pdo = new PDO(
                'pgsql:host=localhost;port=5432;dbname=athos', # DSN (Data Source Name) para PostgreSQL.
                'athos', # Nome de usuário do banco de dados.
                'athos777', # Senha do banco de dados.
